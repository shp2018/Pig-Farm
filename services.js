...
function moreinfo(name, category, breed, height, weight, skillName, skillVal, personality) {
...
function confirmdelete(name, category) {
    if (confirm("Are you sure you want to delete?") == true) {
        deletebutton(name, category);
    }
}
function deletebutton(name, category) {
    if (category == "Black") {
        var barr = [];
        var black = bpig.pig;
...
function myFunction(name, category, breed, height, weight, skillName, skillVal, personality) {
